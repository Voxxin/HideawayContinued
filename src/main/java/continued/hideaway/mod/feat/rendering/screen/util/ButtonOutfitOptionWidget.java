...
public class ButtonOutfitOptionWidget extends AbstractWidget {

    WardrobeConfigModel configModel;
    int[] size;
    int[] pos;

    boolean rightBtnReleased = true;

    public ButtonOutfitOptionWidget(int x, int y, int width, int height, WardrobeConfigModel configModel) {
    ...
    private void clicked() {
        ...
        HideawayPlusConfig.updateOutfitConfig();
